 ...
 * @author Aditya
 */
public class EditTaskServlet1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditTaskServlet1</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            String[] temp = request.getParameterValues("status");
            ...
            else
            {
             ...
             {
                 response.sendRedirect("StudentModule/pending.jsp");
             }
             else
             {
            ...
            out.println("<h1>Servlet EditTaskServlet1 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
