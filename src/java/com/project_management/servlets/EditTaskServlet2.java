...
public class EditTaskServlet2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditTaskServlet2</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            String status = "COMPLETED";
             ...
             {
                 response.sendRedirect("StudentModule/inprogress.jsp");
             }
             else
             {
            ...
            out.println("<h1>Servlet EditTaskServlet2 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
