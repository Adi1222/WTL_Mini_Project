...
public class AddTeamMemberServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddTeamMemberServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            if(db.addTeamMember(teamid, rollno))
            {
                  response.sendRedirect("StudentModule/teams.jsp");
            }
            else
            {
            ...
            out.println("<h1>Servlet AddTeamMemberServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
