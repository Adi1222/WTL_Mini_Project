...
public class Task {
    ...
    public Task(int id, String title, String description, int teamId, String status, String mentorApproval, String coordinatorApproval, Timestamp timestamp, Timestamp deadline ,String grade) {
        this.id = id;
        this.title = title;
        this.description = description;
        this.teamId = teamId;
